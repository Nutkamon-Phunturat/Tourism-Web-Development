...
<nav class="navbar navbar-expand-lg navbar-light shadow">
    ...
    <?php
        ...
        $sql = "SELECT * FROM EmergencyCalls WHERE EiD = $Id";
...
<div class="container">
    <div id="page-container">
        ...
        <div class='col-md-12 text-Center'>
            <form method='Post' action = 'EmerUpdatePro.php'>
                <h5> Update Emergency Calls</h5>
                
                <br>

                <input class = 'inputBox' name = 'eName' value = '<?php echo $row["eName"]; ?>'></input>

                <br><br>

                <input class = 'inputBox' name = 'eTel' value = '<?php echo $row["eTel"]; ?>'></input>
