...
<head>
  ...
  <title>Phubot | Emergency Calls</title>
...
<nav class="navbar navbar-expand-lg navbar-light shadow">
  ...
  <div class="container">
      <div class='col-md-4 mx-auto'>
        <form method = 'Post' action = 'EmerInsert.php'>
      ...
      <?php
                ...
                if (isset($search)) {
                  $sql = "SELECT * FROM EmergencyCalls WHERE eName LIKE '%$search%'";
                } else {
                  $sql = "SELECT * FROM EmergencyCalls";
                }
                ...
                echo '<th>';
                echo 'Emergency Call Name';
                echo '</th>';

                echo '<th>';
                echo 'Emergency Call Number';
                echo '</th>';
                ...
                while ($row = mysqli_fetch_array($result)) {
                  echo '<tr>';
                   ...
                   echo '<td>';
                   echo '<form method="post" action="EmerUpdate.php">';
                   echo '<input type="hidden" name="id" value="'.$row['EiD'].'">';
                   echo '<input type="submit" class = "btn btn-secondary" name="submit_update" value = "Update"></input>';
                   echo '</form>';
                   echo '</td>';
